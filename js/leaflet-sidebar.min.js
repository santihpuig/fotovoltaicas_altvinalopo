(L.Control.Sidebar = L.Control.extend({
  ...
  onAdd: function (t) {
    ...
    for (
      (o = this._container) ||
        ...
        ((o = L.DomUtil.create("div", "leaflet-sidebar collapsed")).id =
          this.options.container),
  ...
  addPanel: function (t) {
    ...
    if (
      (s
        ? (l = !0)
        : (s = L.DomUtil.create("li", t.disabled ? "disabled" : "")),
      ((n = L.DomUtil.create("a", "", s)).href = "#" + t.id),
      n.setAttribute("role", "tab"),
      (n.innerHTML = t.tab),
      (s._sidebar = this),
      (s._id = t.id),
      (s._button = t.button),
      t.title && "<" !== t.title[0] && (s.title = t.title),
      l ||
        ("bottom" === t.position
          ? this._tabContainerBottom.appendChild(s)
          : this._tabContainerTop.appendChild(s),
        this._tabitems.push(s)),
      t.pane)
    ) {
      if (l) {
        for (e = 0; e < this._panes.length; e++)
          if (this._panes[e].id === t.id) {
            i = this._panes[e];
            break;
          }
        "string" == typeof t.pane
          ? ((a = ""),
            t.title && (a += '<h1 class="leaflet-sidebar-header">' + t.title),
            this.options.closeButton &&
              (a +=
                '<span class="leaflet-sidebar-close"><i class="fa fa-times"></i></span>'),
            t.title && (a += "</h1>"),
            (i.innerHTML = a + t.pane))
          : (i.innerHTML = t.pane.innerHTML);
      } else
        "string" == typeof t.pane
          ? ((i = L.DomUtil.create(
              "DIV",
            ...
            t.title && (a += "</h1>"),
            (i.innerHTML = a + t.pane))
          : ((i = t.pane), this._paneContainer.appendChild(i)),
          (i.id = t.id),
          this._panes.push(i);
      (o = i.querySelectorAll(".leaflet-sidebar-close")).length &&
        (this._closeButtons.push(o[o.length - 1]),
        this._closeClick(o[o.length - 1], "on"));
    }
    return this._tabClick(s, "on"), this;
  },
