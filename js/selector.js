...
var overlayMaps = {
    ...
    children: [
        {
        label: '<b>Centrales solares</b>',
        selectAllCheckbox: true,
        collapsed: false,
        children: [
            { label: '<b style="color:#499113">Plantas en funcionamiento</b>', layer: enFuncionamiento },
            { label: '<b style="color:#ff4526">Plantas con informe desfavorable</b>', layer: desfavorable },
            { label: '<b style="color:#fdcc14">Plantas en aprobación</b>', layer: enAprobacion },
            { label: '<b style="color:#fdcc14">Líneas de alta tensión en aprobación</b>', layer: altatension },
            { label: '<b style="color:#fdcc14">Líneas de 30kv en aprobación</b>', layer: lineas30 },
            { label: '<b style="color:#fdcc14">Subestaciones en fase de aprobación</b>', layer: subestaciones },
            { label: '<b style="color:#fdcc14">Plantas en trámite en GVA</b>', layer: tramiteICV }
        ]
        }, {
        label: 'Art. 09 <b><a target="_blank" href="http://www.dogv.gva.es/portal/ficha_disposicion.jsp?L=1&sig=006679%2F2020">DL 14/2020</a></b>',
        selectAllCheckbox: true,
        collapsed: true,
        children: [
        ...
        {
        label: 'Art.10 <b><a target="_blank" href="http://www.dogv.gva.es/portal/ficha_disposicion.jsp?L=1&sig=006679%2F2020">DL 14/2020</a></b> (puede tardar en cargar)',
        selectAllCheckbox: true,
        collapsed: true,
        children: [
    ...
    var seleccionador = new L.Control.Layers.Tree(baseMaps, overlayMaps, { collapsed: false }).addTo(map);
